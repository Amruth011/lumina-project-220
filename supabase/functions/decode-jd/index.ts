        ...
        try {
            const groqResponse = await fetch("https://api.groq.com/openai/v1/chat/completions", {
                ...
                body: JSON.stringify({
                    model: model,
                    messages: [
                        { role: "system", content: "You are Lumina Ultra. Analyze the JD and return JSON. IMPORTANT: Scores/metrics MUST be raw integers (no symbols like %, $, etc). Use plain strings for 'experience', 'education', 'titles', and 'category' fields. Match the SCHEMA keys EXACTLY. Return ONLY raw JSON." },
