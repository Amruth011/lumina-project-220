...
export const StatsSection = () => {
  ...
  return (
    <section ref={ref} className="bg-background border-y border-border/8 py-20 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0">
        {stats.map((stat, i) => (
          <div
            key={i}
          ...
          >
            ...
            <p className="text-xs md:text-sm font-body font-bold text-muted-foreground uppercase tracking-widest">
              {stat.label}
            </p>
          </div>
        ))}
