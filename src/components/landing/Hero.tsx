    ...
    <section className="relative min-h-screen flex flex-col items-center justify-between bg-gradient-to-b from-lumina-teal-dark via-lumina-teal to-[#f4f5f7] overflow-hidden pt-32 pb-24 text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center flex-1 flex flex-col justify-center items-center gap-12 w-full">
        ...
        <div className="space-y-6 max-w-5xl">
          ...
          >
            <span 
              className="block font-bold text-[51.9px] md:text-[77.9px] lg:text-[82.2px] text-white"
              style={{ fontFamily: 'Helvetica, "Helvetica Neue", Arial, sans-serif', letterSpacing: '0.03em' }}
            >
