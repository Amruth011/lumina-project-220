...
export const JdActionCta = ({ onCheckResume }: JdActionCtaProps) => {
  return (
    ...
    >
      ...
      <div className="relative z-10 px-6 py-6 md:py-8 flex flex-col items-center text-center space-y-4">
        <div className="space-y-4 max-w-3xl">
          ...
          <h2 className="text-2xl md:text-3xl font-serif italic text-white tracking-tight leading-tight">
            Found a Role That Looks Good?
          </h2>
          
          <p className="text-white/80 text-[11px] md:text-xs max-w-xl mx-auto font-medium leading-tight px-4">
            Check if your professional profile matches these requirements to maximize your success probability.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <motion.button
            ...
            className="group flex items-center gap-4 px-6 py-2.5 rounded-full bg-white text-blue-600 text-[11px] font-black uppercase tracking-widest shadow-[0_10px_20px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_30px_rgba(0,0,0,0.15)] transition-all"
          >
            Check Your Resume 
